...
<div class="user">
    ...
    <div class="user-name">
        <h2>Invest by using Dogecoin</h2>
    </div>
    ...
    <div class="address-card">
        <div class="address">
            <div class="logo">
                <img src="images/dogecoin.png" alt="coincloud" width="300">
            </div>

            <div class="wallet-address">
                <p>(Please note that you can only send Dogecoin to us on this address)</p>
            </div>
        ...
        <div class="address">
            <form action="invest/dogecoin/{{ Auth::id() }}" method="POST" enctype="multipart/form-data" >
                @csrf
