...
<html lang="en">
    <head>
        ...
        <title>Saxotrade Admin Dashboard</title>
        ...
        <div class="dashboard">
            ...
            <div class="nav-bar">
                ...
                <div class="user-profile">
                    ...
                    <div class="name">
                        <div class="image">
                            <img src="{{ asset('images/user-image 01.png') }}" alt="user-image" width="100" />
                        </div>
                ...
                <div class="nav-menu">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                          <li><a class="dropdown-item" href="/admin_crypto_invest">Cryptocurency</a></li>
                          <li><a class="dropdown-item" href="#">NFTs</a></li>
                ...
                <div class="nav-menu">
                    <div class="icon">
                        <img src="{{ asset('images/wallet icon.png') }}" alt="dashboard" width="40">
                    </div>
                    <div class="dropdown">
                        <a class="menu fw-bold ms-2 dropdown-toggle" href="admin_invest" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                          Addresses
                        ...
                        <ul class="dropdown-menu">
                          <li><a class="dropdown-item" href="profile">Active Addresses</a></li>
                          <li><a class="dropdown-item" href="update_profile">Update Addresses</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="nav-menu">
                    <div class="icon">
                        <img src="{{ asset('images/request icon 4.png') }}" alt="dashboard" width="40">
                    </div>
                    <div class="dropdown">
                        <a class="menu fw-bold ms-2 dropdown-toggle" href="admin_invest" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                          Requests
                        ...
                        <ul class="dropdown-menu">
                          <li><a class="dropdown-item" href="profile">Upgrade plan</a></li>
                          <li><a class="dropdown-item" href="update_profile">Withdraws</a></li>
                          <li><a class="dropdown-item" href="auth/logout">Approved Request</a></li>
                        </ul>
                    </div>
                </div>
