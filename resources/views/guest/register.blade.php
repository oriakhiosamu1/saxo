        ...
        <div class="form">
            <form action="{{ route('auth/register') }}" method="POST">
                ...
                <div class="double-input">
                  <div class="form-input">
                    <input type="text" name="mobile_number" placeholder="Mobile number" id="">
                    <div class="error-message">
                        @error('mobile_number')
                            <small>{{ $message }}</small>
                        @enderror
                ...
                <div class="form-input">
                    <select name="account_type" id="">
                      ...
                      <option value="NFT-trading">NFT trading</option>
                    </select>
                    <div class="error-message">
                        @error('account_type')
                            <small>{{ $message }}</small>
            ...
            <div class="already-have">
                <small>Already have an <span><a href="{{ route('login') }}">account?</a></span></small>
            </div>
        </div>
    </div>
